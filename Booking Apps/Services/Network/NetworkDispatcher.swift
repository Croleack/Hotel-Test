...
final class NetworkDispatcher: INetworkDispatcher {
    ...
    func fetchHotels(
	   completion: @escaping (Result<HotelModel, NetworkError>) -> Void
    ) {
    ...
    func fetchRooms(
	   completion: @escaping (Result<RoomModel, NetworkError>) -> Void
    ) {
    ...
    func fetchBooking(
	   completion: @escaping (Result<BookingModel, NetworkError>) -> Void
    ) {
